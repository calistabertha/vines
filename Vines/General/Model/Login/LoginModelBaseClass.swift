...
public final class LoginModelBaseClass: NSCoding {
  ...
  public var data: LoginModelData?
  ...
  public required init(json: JSON) {
    ...
    data = LoginModelData(json: json[SerializationKeys.data])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? LoginModelData
