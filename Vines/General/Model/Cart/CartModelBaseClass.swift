...
public final class CartModelBaseClass: NSCoding {
    ...
    public required init(json: JSON) {
        ...
        if let items = json[SerializationKeys.data].array { data = items.map { CartModelData(json: $0) } }
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [CartModelData]
