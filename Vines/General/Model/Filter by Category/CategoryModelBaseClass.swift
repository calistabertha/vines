...
public final class CategoryModelBaseClass: NSCoding {
    ...
    public var data: [CategoryModelData]?
    ...
    public required init(json: JSON) {
        ...
        if let items = json[SerializationKeys.data].array { data = items.map { CategoryModelData(json: $0) } }
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [CategoryModelData]
