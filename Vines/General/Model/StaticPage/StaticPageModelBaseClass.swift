//
//  StaticPageModelBaseClass.swift
//
...
public final class StaticPageModelBaseClass: NSCoding {
  ...
  public var data: [StaticPageModelData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { StaticPageModelData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [StaticPageModelData]
