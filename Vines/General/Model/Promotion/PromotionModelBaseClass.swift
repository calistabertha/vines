...
public final class PromotionModelBaseClass: NSCoding {
  ...
  public var data: [PromotionModelData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { PromotionModelData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [PromotionModelData]
