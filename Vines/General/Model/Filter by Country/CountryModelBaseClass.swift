...
public final class CountryModelBaseClass: NSCoding {
    ...
    public var data: [CountryModelData]?
    ...
    public required init(json: JSON) {
        ...
        if let items = json[SerializationKeys.data].array { data = items.map { CountryModelData(json: $0) } }
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [CountryModelData]
