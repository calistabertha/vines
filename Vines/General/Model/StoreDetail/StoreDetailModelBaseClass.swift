//
//  StoreDetailModelBaseClass.swift
//
...
public final class StoreDetailModelBaseClass: NSCoding {
  ...
  public var data: [StoreDetailModelData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { StoreDetailModelData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [StoreDetailModelData]
