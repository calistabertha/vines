...
public final class StoreListModelBaseClass: NSCoding {
  ...
  public var data: [StoreListModelData]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.data].array { data = items.map { StoreListModelData(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [StoreListModelData]
