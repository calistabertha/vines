...
public final class OrderModelBaseClass: NSCoding {
    ...
    public var data: [OrderModelData]?
    ...
    public required init(json: JSON) {
        ...
        if let items = json[SerializationKeys.data].array { data = items.map { OrderModelData(json: $0) } }
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [OrderModelData]
